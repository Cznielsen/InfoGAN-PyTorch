...
class Generator(nn.Module):
    ...
    def __init__(self):
        ...
        self.tconv0 = nn.ConvTranspose2d(512, 256, 4, 2, padding=1, bias=True)
        self.bn0 = nn.BatchNorm2d(256)

        self.tconv1 = nn.ConvTranspose2d(256, 128, 4, 2, padding=1, bias=True)
        self.bn3 = nn.BatchNorm2d(128)

        self.tconv2 = nn.Conv2d(128, 1, 1, 1, 0, bias=True)
